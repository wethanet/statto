...
create or replace function public.get_club_fixture_availability_records(
  target_club_id text,
  target_fixture_id text
)
returns table (
...
grant execute on function public.get_club_fixture_availability_records(text, text) to authenticated;
